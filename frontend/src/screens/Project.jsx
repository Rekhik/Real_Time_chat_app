 ...
 function WriteAiMessage(message){
  ...
  return (
    <main className='h-screen w-screen flex'>
      <section className="left relative flex flex-col h-screen min-w-96 bg-blue-100 ">
        ...
        <div className="conversation-area pt-14 pb-10 flex-grow flex flex-col h-full relative ">
          ...
          <div className="inputField w-full flex absolute bottom-0">
            ...
            className=' px-5 bg-slate-700 text-white'>
      ...
      <section className='right bg-red-50 flex-grow h-full flex'>
            ...
            <div className="code-editor flex flex-col flex-grow h-full shrink">
                 <div className="top flex justify-beteen w-full">
        ...
        <div className='fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center'>
          <div className='bg-white p-4 rounded-md w-96 max-w-full relative'>
            ...
            <div className='users-list flex flex-col gap-2 mb-16 max-h-96 overflow-auto'>
              ...
              >
                <div className='aspect-square relative rounded-full w-fit h-fit flex justify-center items-center p-5 text-white bg-slate-600'>
                  <i className="ri-user-fill absolute"></i>
                </div>
            ...
            className='absolute bottom-4 left-1/2 transform -translate-x-1/2 px-4 py-2 bg-blue-600 text-white rounded-md'>Add Collaborators</button>
          </div>
        </div>
      )}
